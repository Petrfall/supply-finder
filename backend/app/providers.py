...
class OpenAIProvider:
    ...
    def find_suppliers(self, req: SearchRequest) -> list[Supplier]:
        ...
        sys = (
            ...
            "размести часть поставщиков там или с доставкой туда. "
            f"В поле category ОБЯЗАТЕЛЬНО используй формулировку запроса — «{req.category}» "
            "(можешь уточнить в description). Заполняй ВСЕ "
